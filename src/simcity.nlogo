...
"Inhabitants Happiness" 1.0 0 -12030287 true "" "plot getInhabitantsHappiness"
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="showElectricity">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="businessTax">
      <value value="50"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="houseTax">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="showLabels">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="showWater">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="incomeTaxRate">
      <value value="0.03"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="showPersons">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="showOffers">
      <value value="true"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
